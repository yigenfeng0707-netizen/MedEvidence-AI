...
- [x] 魔搭创空间部署（6/27 上线，docker 模式，健康检查+检索接口验证通过）
- [x] smart_tool.json 的 entry_point 更新为魔搭线上地址（`https://gsym236998-medevidence-ai.ms.show/api/v1/search`）
...
| 魔搭创空间部署 | 100% | ✅ 6/27 上线，健康检查+检索接口验证通过 |
| 演示视频 | 0% | ⏳ 待开始 |
| 飞书表单 | 0% | ⏳ 待开始 |
| **总体进度** | **约 85%** | 🟢 魔搭部署完成，待演示视频和飞书登记 |
...
3. [x] ~~魔搭创空间部署~~ — 6/27 上线，地址：https://gsym236998-medevidence-ai.ms.show
4. [x] ~~smart_tool.json entry_point 更新~~ — 已更新为魔搭线上地址
